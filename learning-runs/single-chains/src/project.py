...
def coarse_grained(job):
    return job.isfile("components.gsd")
    ...
    with job:
        ...
        if job.sp.system_type != "interface":
            system_parms = system.System(
                    ...
                    para_weight=None,
                    monomer_sequence=job.doc.pm_sequence,
