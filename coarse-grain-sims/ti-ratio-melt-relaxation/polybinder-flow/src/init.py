...
def get_parameters():
    ...
    parameters["box_constraints"] = [None]
    parameters["kwargs"] = [{}]
    ...
    parameters["init_shrink_kT"] = [16.0]
    parameters["final_shrink_kT"] = [16.0]
    parameters["shrink_steps"] = [5e7]
    ...
    parameters["kT_quench"] = [
        1.2, 1.4, 1.6, 1.8, 2.0, 2.2, 2.4, 2.6, 2.8, 3.0, 4.0, 5.0, 6.0
    ]
    parameters["n_steps"] = [1e9]
...
def main():
    project = signac.init_project("bulk-anneal") # Set the signac project name
