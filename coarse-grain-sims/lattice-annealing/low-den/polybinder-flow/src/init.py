...
def get_parameters():
    ...
    parameters["box_constraints"] = [
            {"x": 0.606 * 7, "y": 0.767 * 7, "z": None},
            {"x": 0.606 * 8, "y": 0.767 * 8, "z": 31.7993},
            {"x": 0.606 * 9, "y": 0.767 * 9, "z": 31.7993},
            {"x": 0.606 * 10, "y": 0.767 * 10, "z": 31.7993},
            {"x": 0.606 * 11, "y": 0.767 * 11, "z": 31.7993},
    ]
    parameters["kwargs"] = [
            {"n": 7, "a": 0.606, "b": 0.767},  # Form 1 (1.35 g/cm^3)
            #{"n": 7, "a": 0.417, "b": 1.134}, # Form 2 (1.38g/cm^3)
	]
    ...
    parameters["init_shrink_kT"] = [0.1]
    parameters["final_shrink_kT"] = [0.1]
    parameters["shrink_steps"] = [5e2]
    ...
    #parameters["kT_quench"] = [0.5, 1.0, 1.5, 2.5]
...
def main():
    project = signac.init_project("anneal") # Set the signac project name
