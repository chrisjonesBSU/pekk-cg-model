...
def sample(job):
    ...
    with job:
        ...
        system.set_target_box(
                x_constraint=job.sp.box_constraints["x"],
                y_constraint=job.sp.box_constraints["y"],
                z_constraint=job.sp.box_constraints["z"],
        )
        ...
        simulation = simulate.Simulation(
                ...
                mode="gpu",
                gsd_write=max([int(job.doc.steps/2000), 1]),
        ...
        if job.sp.procedure == "quench":
            ...
            print("-----------------------------")
        #simulation.quench(kT=job.sp.kT_anneal[1], n_steps=5e7)
        job.doc.done = True
        print("-----------------------------")
